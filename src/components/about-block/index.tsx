...
import Photo1 from '../../assets/img/11111.jpeg'
import { about } from '../../data'
import {
  SmoothItem,
  useSmoothAppearance,
} from '../../hooks/useSmoothAppearance'
import {
  Container,
  FirstLine,
  FirstText,
...
export const AboutBlock: React.FC = () => {
  ...
  return (
    <Container id="about-block" ref={trigger}>
      <FirstLine>
        <div>
          <img alt="adil" className="image" src={Photo1} />
          <TitleBlock top />
        </div>

        <FirstText className="first-text">{TEXT[0]}</FirstText>
      </FirstLine>
      ...
      <ThirdText className="third-text">{TEXT[2]}</ThirdText>
    </Container>
  )
}
